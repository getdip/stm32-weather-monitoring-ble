...
uint8_t ds1307_init(void)
{
	...
	//4. Make clock halt = 0;
	ds1307_write(0x00,DS1307_ADDR_SEC); //Make CH bit = 0
...
void ds1307_set_current_date(RTC_date_t *rtc_date)
{
	...
	day = binary_to_bcd(rtc_date->day +1 );
...
void ds1307_data_time_initialization(RTC_time_t *rtc_time,RTC_date_t *rtc_date){

	if (ds1307_read(DS1307_ADDR_SEC) & (1<<7)){
...
{
	rtc_date->day =  bcd_to_binary(ds1307_read(DS1307_ADDR_DAY))-1;
